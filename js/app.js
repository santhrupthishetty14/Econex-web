document.addEventListener('DOMContentLoaded', () => {
  ...
  if (contactForm) {
    contactForm.addEventListener('submit', (e) => {
      ...
      // Simulate B2B API Lead ingestion post (1.5 seconds delay)
      setTimeout(() => {
        ...
        // Remove error outline leftovers if any
        Object.values(inputs).forEach(input => {
          if (input) input.classList.remove('error');
        });

        // Trigger Success feedback
        showToast('Consultation Requested', 'Thank you! Our technical team will call you within 24 business hours.');
      }, 1500);
    });
  }
